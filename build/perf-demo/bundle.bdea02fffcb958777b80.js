 ...
 */const V=new WeakMap,P=e=>(...t)=>{const s=e(...t);return V.set(s,!0),s},A=e=>"function"==typeof e&&V.has(e),H=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,M=(e,t,s=null,n=null)=>{for(;t!==s;){const s=t.nextSibling;e.insertBefore(t,n),t=s}},T=(e,t,s=null)=>{for(;t!==s;){const s=t.nextSibling;e.removeChild(t),t=s}},j={},L={},I=`{{lit-${String(Math.random()).slice(2)}}}`,R=`\x3c!--${I}--\x3e`,q=new RegExp(`${I}|${R}`),U="$lit$";class W{constructor(e,t){this.parts=[],this.element=t;const s=[],n=[],i=document.createTreeWalker(t.content,133,null,!1);let o=0,r=-1,a=0;const{strings:l,values:{length:h}}=e;for(;a<h;){const e=i.nextNode();if(null!==e){if(r++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:s}=t;let n=0;for(let e=0;e<s;e++)F(t[e].name,U)&&n++;for(;n-- >0;){const t=l[a],s=D.exec(t)[2],n=s.toLowerCase()+U,i=e.getAttribute(n);e.removeAttribute(n);const o=i.split(q);this.parts.push({type:"attribute",index:r,name:s,strings:o}),a+=o.length-1}}"TEMPLATE"===e.tagName&&(n.push(e),i.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(I)>=0){const n=e.parentNode,i=t.split(q),o=i.length-1;for(let t=0;t<o;t++){let s,o=i[t];if(""===o)s=z();else{const e=D.exec(o);null!==e&&F(e[2],U)&&(o=o.slice(0,e.index)+e[1]+e[2].slice(0,-U.length)+e[3]),s=document.createTextNode(o)}n.insertBefore(s,e),this.parts.push({type:"node",index:++r})}""===i[o]?(n.insertBefore(z(),e),s.push(e)):e.data=i[o],a+=o}}else if(8===e.nodeType)if(e.data===I){const t=e.parentNode;null!==e.previousSibling&&r!==o||(r++,t.insertBefore(z(),e)),o=r,this.parts.push({type:"node",index:r}),null===e.nextSibling?e.data="":(s.push(e),r--),a++}else{let t=-1;for(;-1!==(t=e.data.indexOf(I,t+1));)this.parts.push({type:"node",index:-1}),a++}}else i.currentNode=n.pop()}for(const e of s)e.parentNode.removeChild(e)}}const F=(e,t)=>{const s=e.length-t.length;return s>=0&&e.slice(s)===t},B=e=>-1!==e.index,z=()=>document.createComment(""),D=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function he(e){let t=de.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},de.set(e.type,t));let s=t.stringsArray.get(e.strings);if(void 0!==s)return s;const n=e.strings.join(I);return s=t.keyString.get(n),void 0===s&&(s=new W(e,e.getTemplateElement()),t.keyString.set(n,s)),t.stringsArray.set(e.strings,s),s}const de=new Map,ce=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const ue=(e,t)=>{const s=e.startNode.parentNode,n=void 0===t?e.endNode:t.startNode,i=s.insertBefore(z(),n);s.insertBefore(z(),n);const o=new te(e.options);return o.insertAfterNode(i),o},pe=(e,t)=>(e.setValue(t),e.commit(),e),fe=(e,t,s)=>{const n=e.startNode.parentNode,i=s?s.startNode:e.endNode,o=t.endNode.nextSibling;o!==i&&M(n,t.startNode,o,i)},me=e=>{T(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},ge=(e,t,s)=>{const n=new Map;for(let i=t;i<=s;i++)n.set(e[i],i);return n},ve=new WeakMap,_e=new WeakMap,be=P((e,t,s)=>{let n;return void 0===s?s=t:void 0!==t&&(n=t),t=>{if(!(t instanceof te))throw new Error("repeat can only be used in text bindings");const i=ve.get(t)||[],o=_e.get(t)||[],r=[],a=[],l=[];let h,d,c=0;for(const t of e)l[c]=n?n(t,c):c,a[c]=s(t,c),c++;let u=0,p=i.length-1,f=0,m=a.length-1;for(;u<=p&&f<=m;)if(null===i[u])u++;else if(null===i[p])p--;else if(o[u]===l[f])r[f]=pe(i[u],a[f]),u++,f++;else if(o[p]===l[m])r[m]=pe(i[p],a[m]),p--,m--;else if(o[u]===l[m])r[m]=pe(i[u],a[m]),fe(t,i[u],r[m+1]),u++,m--;else if(o[p]===l[f])r[f]=pe(i[p],a[f]),fe(t,i[p],i[u]),p--,f++;else if(void 0===h&&(h=ge(l,f,m),d=ge(o,u,p)),h.has(o[u]))if(h.has(o[p])){const e=d.get(l[f]),s=void 0!==e?i[e]:null;if(null===s){const e=ue(t,i[u]);pe(e,a[f]),r[f]=e}else r[f]=pe(s,a[f]),fe(t,s,i[u]),i[e]=null;f++}else me(i[p]),p--;else me(i[u]),u++;for(;f<=m;){const e=ue(t,r[m+1]);pe(e,a[f]),r[f++]=e}for(;u<=p;){const e=i[u++];null!==e&&me(e)}ve.set(t,r),_e.set(t,l)}}),ye=new WeakMap,we=P((e,t)=>s=>{const n=ye.get(s);if(Array.isArray(e)){if(Array.isArray(n)&&n.length===e.length&&e.every((e,t)=>e===n[t]))return}else if(n===e&&(void 0!==e||ye.has(s)))return;s.setValue(t()),ye.set(s,Array.isArray(e)?Array.from(e):e)}),xe=P(e=>t=>{if(void 0===e&&t instanceof ee){if(e!==t.value){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else t.setValue(e)});let Ee={html:(e,...t)=>new X(e,t,"html",le),svg:(e,...t)=>new Y(e,t,"svg",le),render:(e,t,s)=>{let n=ce.get(t);void 0===n&&(T(t,t.firstChild),ce.set(t,n=new te(Object.assign({templateFactory:he},s))),n.appendInto(t)),n.setValue(e),n.commit()},directive:P,repeat:be,guard:we,ifDefined:xe};window.__litHtml?Ee=window.__litHtml:window.__litHtml=Ee;const{html:$e,svg:Ne,render:Se,directive:Ce,repeat:ke,guard:Oe,ifDefined:Ve}=Ee;class Pe extends HTMLElement{constructor(e=!0){super(),this.setState=this.setState.bind(this),this.willMount=this.willMount.bind(this),this.render=this.render.bind(this),this.mounted=this.mounted.bind(this),this.shouldUpdate=this.shouldUpdate.bind(this),this.__update=this.__update.bind(this),this.updated=this.updated.bind(this),this.attributeChanged=this.attributeChanged.bind(this),this.propertyChanged=this.propertyChanged.bind(this),this.unmounted=this.unmounted.bind(this),this.__renderRoot=e?this.attachShadow({mode:"open"}):this;const{observedAttributes:t,observedPropertys:s,defineEvents:n,observedStores:i,adoptedStyleSheets:o}=new.target;t&&t.forEach(e=>{const t=function(e){return e.replace(/-(.)/g,(e,t)=>t.toUpperCase())}(e);if("function"==typeof this[t])throw"Don't use attribute with the same name as native methods";void 0===this[t]&&Object.defineProperty(this,t,{configurable:!0,get(){return this.getAttribute(e)||""},set(t){null===t?this.removeAttribute(e):this.setAttribute(e,t)}})}),s&&s.forEach(e=>{this.__connectProperty(e,!1)}),n&&n.forEach(e=>{this.__connectProperty(e,!0),this[e]=c}),i&&i.forEach(e=>{if(!e[u])throw new Error("`observedStores` only support store module");!function(e,t){e[u].add(t)}(e,this.__update)}),o&&(this.shadowRoot?this.shadowRoot.adoptedStyleSheets=o:document.adoptedStyleSheets=document.adoptedStyleSheets.concat(o))}get internals(){return this.__internals||(this.__internals=this.attachInternals()),this.__internals}__connectProperty(e,t=!1){if(e in this)return;let s=this[e];Object.defineProperty(this,e,{configurable:!0,get:()=>s,set(n){if(n!==s){if(t){if(n.isEventHandle)throw"Don't assign a wrapped event handler";s=t=>{const s=new CustomEvent(e.toLowerCase(),{detail:t});this.dispatchEvent(s),n(s)},s.isEventHandle=!0}else s=n;this.__isMounted&&(this.propertyChanged(e,s,n),i(this.__update))}}})}setState(e){if(!this.state)throw new Error("`state` not initialized");Object.assign(this.state,e),i(this.__update)}willMount(){}render(){return $e`
    ...
    `}mounted(){}shouldUpdate(){return!0}__update(){this.__isMounted&&this.shouldUpdate()&&(Se(this.render(),this.__renderRoot),i(this.updated))}update(){this.__update()}updated(){}propertyChanged(e,t,s){}attributeChanged(e,t,s){}unmounted(){}attributeChangedCallback(e,t,s){this.__isMounted&&(this.attributeChanged(e,t,s),i(this.__update))}__connectedCallback(){Se(this.render(),this.__renderRoot);const e=this.mounted();"function"==typeof e&&(this.__unmountCallback=e),this.__isMounted=!0}disconnectedCallback(){var e;const t=this.constructor;t.observedStores&&t.observedStores.forEach(e=>{!function(e,t){e[u].delete(t)}(e,this.__update)}),null===(e=this.__unmountCallback)||void 0===e||e.call(this),this.unmounted(),this.__isMounted=!1}}class Ae extends Pe{connectedCallback(){this.willMount(),this.__connectedCallback()}}const He=new r;let Me=!1;const Te=()=>{window.requestAnimationFrame((function e(t){const s=He.get();s&&(s(),performance.now()-t<16)?e(t):Me&&Te()}))};He.addEventListener("start",()=>{Me=!0,Te()}),He.addEventListener("end",()=>Me=!1);class je extends Pe{__update(){He.add(()=>{this.shouldUpdate()&&(Se(this.render(),this.__renderRoot),this.updated())})}connectedCallback(){this.willMount(),He.add(()=>{this.__connectedCallback()})}}const Le=customElements.define.bind(customElements);var Ie;customElements.define=function(e,t,s){customElements.get(e)||Le(e,t,s)};const Re=p({number:1});setInterval(()=>{f(Re,{number:Re.number%10+1})},1e3),customElements.define("fiber-dot",((Ie=class extends je{constructor(){super(...arguments),this.onmouseenter=()=>{this.setState({hover:!0})},this.onmouseleave=()=>{this.setState({hover:!1})},this.state={hover:!1}}render(){const e=1.3*this.size;return Object.assign(this.style,{width:e+"px",height:e+"px",left:this.x+"px",top:this.y+"px",borderRadius:e/2+"px",lineHeight:e+"px",background:this.state.hover?"#ff0":"#61dafb"}),$e`
        ...
        ${this.state.hover?"**"+Re.number+"**":Re.number}
      `}}).observedStores=[Re],Ie));customElements.define("fiber-triangle",class extends Ae{render(){let e=this.s;if(e<=25)return $e`
        ...
        <fiber-triangle .x=${this.x+e} .y=${this.y+e/2} .s=${e}></fiber-triangle>
      `}});class qe extends Ae{constructor(){super(...arguments),this.elapsed=0}render(){const e=this.elapsed/1e3%10,t=1+(e>5?10-e:e)/10;return this.style.transform="scaleX("+t/2.1+") scaleY(0.7) translateZ(0.1px)",$e`
      <style>
        :host {
          position: absolute;
    ...
    `}}qe.observedPropertys=["elapsed"],customElements.define("app-root",qe),document.body.innerHTML=l`
  <ul>
...
`;const Ue=new qe;document.body.append(Ue);const We=Date.now();requestAnimationFrame((function e(){Ue.elapsed=Date.now()-We,requestAnimationFrame(e)}))}]);
//# sourceMappingURL=bundle.bdea02fffcb958777b80.js.map