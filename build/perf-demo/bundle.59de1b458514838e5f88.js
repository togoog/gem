!function(e){var t={};function s(n){if(t[n])return t[n].exports;var i=t[n]={i:n,l:!1,exports:{}};return e[n].call(i.exports,i,i.exports,s),i.l=!0,i.exports}s.m=e,s.c=t,s.d=function(e,t,n){s.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:n})},s.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},s.t=function(e,t){if(1&t&&(e=s(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var n=Object.create(null);if(s.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var i in e)s.d(n,i,function(t){return e[t]}.bind(null,i));return n},s.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return s.d(t,"a",t),t},s.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},s.p="/gem/build/perf-demo/",s(s.s=0)}([function(e,t,s){"use strict";s.r(t);const n=new Set;function i(e){n.size||globalThis.queueMicrotask(()=>{n.forEach(e=>e()),n.clear()}),n.delete(e),n.add(e)}class o extends(globalThis.Image||null){constructor(){super(),this.currentId=0,this.count=0,this.pool=new Map,Object.setPrototypeOf(this,o.prototype)}add(e){this.pool.size||this.dispatchEvent(new CustomEvent("start")),this.pool.set(this.count,e),this.count+=1}get(){const e=this.pool.get(this.currentId);return e&&(this.pool.delete(this.currentId),this.currentId+=1,this.pool.size||this.dispatchEvent(new CustomEvent("end"))),e}}class r extends URLSearchParams{constructor(e){if(e instanceof r)return e;super(e),Object.setPrototypeOf(this,r.prototype)}concat(e){let t;t="string"==typeof e?Object.fromEntries(new URLSearchParams(e).entries()):e,Object.keys(t).forEach(e=>{this.append(e,t[e])})}toString(){const e=super.toString();return e?`?${e}`:""}toJSON(){return this.toString()}}function a(e,...t){return e.reduce((e,s,n)=>e+(t[n-1]||"")+s)}new WeakMap;function l(e){return Object.keys(e).forEach(t=>{delete e[t]}),e}class h extends Error{constructor(e){super(e),this.message=`gem: ${this.message}`}}function d(){}const c="gem@storeHandlesKey";function u(e){const t=e;return Object.defineProperty(t,c,{enumerable:!1,value:new Set,writable:!0}),t}function p(e,t){Object.assign(e,t),e[c].forEach(e=>{i(e)})}const f=window.history,m=window.location,g=f.pushState.bind(f),v=f.replaceState.bind(f);let _=0;const b=()=>++_,y=u({$hasCloseHandle:!1,$hasOpenHandle:!1,$hasShouldCloseHandle:!1,$key:0}),w=new Map;function x(e){var t,s,n,i;if(null===(t=e)||void 0===t?void 0:t.$key)throw new h("`$key` is not allowed");if(null===(s=e)||void 0===s?void 0:s.$hasCloseHandle)throw new h("`$hasCloseHandle` is not allowed");if(null===(n=e)||void 0===n?void 0:n.$hasOpenHandle)throw new h("`$hasOpenHandle` is not allowed");if(null===(i=e)||void 0===i?void 0:i.$hasShouldCloseHandle)throw new h("`$hasShouldCloseHandle` is not allowed")}function E(e){const t=e.title||"",s=e.path||("/"===m.pathname?"":m.pathname.replace(new RegExp(`^${f.basePath}`),"")),n=new r(e.query||(e.path?"":m.search)),i=e.path||e.query,o=e.hash||(i?"":m.hash);return Object.assign(Object.assign({},e),{title:t,path:s,query:n,hash:o})}function N(e,t){x(t.data);const s=E(t),{title:n,path:i,query:o,hash:a}=s,h=Object.assign({$hasCloseHandle:!!s.close,$hasOpenHandle:!!s.open,$hasShouldCloseHandle:!!s.shouldClose,$key:b()},s.data||{});w.set(h.$key,s),p(l(y),h);const d=f.basePath+i+new r(o)+a,c=m.hash;("push"===e?g:v)(h,n,d),c!==a&&window.dispatchEvent(new CustomEvent("hashchange"))}function $(e,t,s,n){x(t);const i=Object.assign({$key:b()},t||{}),{pathname:o,search:a,hash:h}=new URL(n,m.origin);m.hash!==h&&window.dispatchEvent(new CustomEvent("hashchange"));const d=E({path:o,query:new r(a),hash:h,title:s,data:t});w.set(i.$key,d),p(l(y),i);const c=f.basePath+n,u=m.hash;("push"===e?g:v)(i,s,c),u!==h&&window.dispatchEvent(new CustomEvent("hashchange"))}const S=u({basePath:""});if(!("basePath"in f)){if(Object.defineProperties(f,{basePath:{get:()=>S.basePath,set(e){if(S.basePath)throw new h("已经有其他环境使用 gem , 会共享 history 对象，禁止再修改 history 对象");Object.assign(w.get(y.$key),{path:window.location.pathname.replace(new RegExp(`^${e}`),"")}),p(S,{basePath:e})}},getParams:{value:function(){return w.get(y.$key)}},updateParams:{value:function(e){Object.assign(w.get(y.$key),e),p(y,{})}},store:{value:y},push:{value:function(e){N("push",e)}},pushIgnoreCloseHandle:{value:function(e){var t,s,n;y.$hasCloseHandle?(null===(n=null===(t=w.get(y.$key))||void 0===t?void 0:(s=t).close)||void 0===n||n.call(s),f.replace(e)):f.push(e)}},replace:{value:function(e){N("replace",e)}},pushState:{value:function(e,t,s){$("push",e,t,s)}},replaceState:{value:function(e,t,s){$("replace",e,t,s)}}}),f.state)if(f.state.$close)f.back();else{const e=E({title:document.title});p(y,Object.assign({$key:b()},f.state||{})),w.set(y.$key,e)}else{const{pathname:e,search:t,hash:s}=m;f.replace({path:e,query:t,hash:s})}let e=!1;window.addEventListener("popstate",t=>{var s,n,i,o,a,h;const d=t.state;if(!(null===(s=d)||void 0===s?void 0:s.$key))return;if(e)return void(e=!1);if(!w.has(d.$key)){const{pathname:e,search:t,hash:s}=m;w.set(d.$key,{path:e,query:new r(t),hash:s,title:document.title,data:d})}const c=y;if(d.$key>c.$key&&d.$hasOpenHandle)null===(o=null===(n=w.get(d.$key))||void 0===n?void 0:(i=n).open)||void 0===o||o.call(i);else if(c.$hasCloseHandle){const t=w.get(c.$key),s=null===(a=t)||void 0===a?void 0:a.close,n=null===(h=t)||void 0===h?void 0:h.shouldClose;if(n&&!n())return e=!0,void f.forward();s?s():(e=!0,f.back())}p(l(y),d)})}
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const he=(e,t)=>{const s=e.startNode.parentNode,n=void 0===t?e.endNode:t.startNode,i=s.insertBefore(F(),n);s.insertBefore(F(),n);const o=new G(e.options);return o.insertAfterNode(i),o},de=(e,t)=>(e.setValue(t),e.commit(),e),ce=(e,t,s)=>{const n=e.startNode.parentNode,i=s?s.startNode:e.endNode,o=t.endNode.nextSibling;o!==i&&P(n,t.startNode,o,i)},ue=e=>{A(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},pe=(e,t,s)=>{const n=new Map;for(let i=t;i<=s;i++)n.set(e[i],i);return n},fe=new WeakMap,me=new WeakMap,ge=k((e,t,s)=>{let n;return void 0===s?s=t:void 0!==t&&(n=t),t=>{if(!(t instanceof G))throw new Error("repeat can only be used in text bindings");const i=fe.get(t)||[],o=me.get(t)||[],r=[],a=[],l=[];let h,d,c=0;for(const t of e)l[c]=n?n(t,c):c,a[c]=s(t,c),c++;let u=0,p=i.length-1,f=0,m=a.length-1;for(;u<=p&&f<=m;)if(null===i[u])u++;else if(null===i[p])p--;else if(o[u]===l[f])r[f]=de(i[u],a[f]),u++,f++;else if(o[p]===l[m])r[m]=de(i[p],a[m]),p--,m--;else if(o[u]===l[m])r[m]=de(i[u],a[m]),ce(t,i[u],r[m+1]),u++,m--;else if(o[p]===l[f])r[f]=de(i[p],a[f]),ce(t,i[p],i[u]),p--,f++;else if(void 0===h&&(h=pe(l,f,m),d=pe(o,u,p)),h.has(o[u]))if(h.has(o[p])){const e=d.get(l[f]),s=void 0!==e?i[e]:null;if(null===s){const e=he(t,i[u]);de(e,a[f]),r[f]=e}else r[f]=de(s,a[f]),ce(t,s,i[u]),i[e]=null;f++}else ue(i[p]),p--;else ue(i[u]),u++;for(;f<=m;){const e=he(t,r[m+1]);de(e,a[f]),r[f++]=e}for(;u<=p;){const e=i[u++];null!==e&&ue(e)}fe.set(t,r),me.set(t,l)}}),ve=new WeakMap,_e=k((e,t)=>s=>{const n=ve.get(s);if(Array.isArray(e)){if(Array.isArray(n)&&n.length===e.length&&e.every((e,t)=>e===n[t]))return}else if(n===e&&(void 0!==e||ve.has(s)))return;s.setValue(t()),ve.set(s,Array.isArray(e)?Array.from(e):e)}),be=k(e=>t=>{if(void 0===e&&t instanceof Z){if(e!==t.value){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else t.setValue(e)});let ye={html:(e,...t)=>new D(e,t,"html",oe),svg:(e,...t)=>new J(e,t,"svg",oe),render:(e,t,s)=>{let n=le.get(t);void 0===n&&(A(t,t.firstChild),le.set(t,n=new G(Object.assign({templateFactory:re},s))),n.appendInto(t)),n.setValue(e),n.commit()},directive:k,repeat:ge,guard:_e,ifDefined:be};window.__litHtml?ye=window.__litHtml:window.__litHtml=ye;const{html:we,svg:xe,render:Ee,directive:Ne,repeat:$e,guard:Se,ifDefined:Ce}=ye;class ke extends HTMLElement{constructor(e=!0){super(),this.setState=this.setState.bind(this),this.willMount=this.willMount.bind(this),this.render=this.render.bind(this),this.mounted=this.mounted.bind(this),this.shouldUpdate=this.shouldUpdate.bind(this),this.__update=this.__update.bind(this),this.updated=this.updated.bind(this),this.attributeChanged=this.attributeChanged.bind(this),this.propertyChanged=this.propertyChanged.bind(this),this.unmounted=this.unmounted.bind(this),this.__renderRoot=e?this.attachShadow({mode:"open"}):this;const{observedAttributes:t,observedPropertys:s,defineEvents:n,observedStores:i,adoptedStyleSheets:o}=new.target;t&&t.forEach(e=>{const t=function(e){return e.replace(/-(.)/g,(e,t)=>t.toUpperCase())}(e);if("function"==typeof this[t])throw"Don't use attribute with the same name as native methods";void 0===this[t]&&Object.defineProperty(this,t,{configurable:!0,get(){return this.getAttribute(e)||""},set(t){null===t?this.removeAttribute(e):this.setAttribute(e,t)}})}),s&&s.forEach(e=>{this.__connectProperty(e,!1)}),n&&n.forEach(e=>{this.__connectProperty(e,!0),this[e]=d}),i&&i.forEach(e=>{if(!e[c])throw new Error("`observedStores` only support store module");!function(e,t){e[c].add(t)}(e,this.__update)}),o&&(this.shadowRoot?this.shadowRoot.adoptedStyleSheets=o:document.adoptedStyleSheets=document.adoptedStyleSheets.concat(o))}__connectProperty(e,t=!1){if(e in this)return;let s=this[e];Object.defineProperty(this,e,{configurable:!0,get:()=>s,set(n){if(n!==s){if(t){if(n.isEventHandle)throw"Don't assign a wrapped event handler";s=t=>{const s=new CustomEvent(e.toLowerCase(),{detail:t});this.dispatchEvent(s),n(s)},s.isEventHandle=!0}else s=n;this.__isMounted&&(this.propertyChanged(e,s,n),i(this.__update))}}})}setState(e){if(!this.state)throw new Error("`state` not initialized");Object.assign(this.state,e),i(this.__update)}willMount(){}render(){return we`
      <slot></slot>
    `}mounted(){}shouldUpdate(){return!0}__update(){this.__isMounted&&this.shouldUpdate()&&(Ee(this.render(),this.__renderRoot),this.updated())}update(){this.__update()}updated(){}propertyChanged(e,t,s){}attributeChanged(e,t,s){}unmounted(){}attributeChangedCallback(e,t,s){this.__isMounted&&(this.attributeChanged(e,t,s),i(this.__update))}__connectedCallback(){Ee(this.render(),this.__renderRoot);const e=this.mounted();e&&(this.__unmountCallback=e),this.__isMounted=!0}disconnectedCallback(){var e;const t=this.constructor;t.observedStores&&t.observedStores.forEach(e=>{!function(e,t){e[c].delete(t)}(e,this.__update)}),null===(e=this.__unmountCallback)||void 0===e||e.call(this),this.unmounted(),this.__isMounted=!1}}class Oe extends ke{connectedCallback(){this.willMount(),this.__connectedCallback()}}const Ve=new o;let Pe=!1;const Ae=()=>{window.requestAnimationFrame((function e(t){const s=Ve.get();s&&(s(),performance.now()-t<16)?e(t):Pe&&Ae()}))};Ve.addEventListener("start",()=>{Pe=!0,Ae()}),Ve.addEventListener("end",()=>Pe=!1);class Me extends ke{__update(){Ve.add(()=>{this.shouldUpdate()&&(Ee(this.render(),this.__renderRoot),this.updated())})}connectedCallback(){this.willMount(),Ve.add(()=>{this.__connectedCallback()})}}const He=customElements.define.bind(customElements);var Te;customElements.define=function(e,t,s){customElements.get(e)||He(e,t,s)};const je=u({number:1});setInterval(()=>{p(je,{number:je.number%10+1})},1e3),customElements.define("fiber-dot",((Te=class extends Me{constructor(){super(...arguments),this.onmouseenter=()=>{this.setState({hover:!0})},this.onmouseleave=()=>{this.setState({hover:!1})},this.state={hover:!1}}render(){const e=1.3*this.size;return Object.assign(this.style,{width:e+"px",height:e+"px",left:this.x+"px",top:this.y+"px",borderRadius:e/2+"px",lineHeight:e+"px",background:this.state.hover?"#ff0":"#61dafb"}),we`
        <style>
          :host {
            position: absolute;
...
//# sourceMappingURL=bundle.59de1b458514838e5f88.js.map