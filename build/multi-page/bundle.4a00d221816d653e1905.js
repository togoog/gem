 ...
 */const A=new WeakMap,H=e=>(...t)=>{const n=e(...t);return A.set(n,!0),n},T=e=>"function"==typeof e&&A.has(e),R=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,V=(e,t,n=null,s=null)=>{for(;t!==n;){const n=t.nextSibling;e.insertBefore(t,s),t=n}},M=(e,t,n=null)=>{for(;t!==n;){const n=t.nextSibling;e.removeChild(t),t=n}},L={},q={},I=`{{lit-${String(Math.random()).slice(2)}}}`,B=`\x3c!--${I}--\x3e`,D=new RegExp(`${I}|${B}`),U="$lit$";class W{constructor(e,t){this.parts=[],this.element=t;const n=[],s=[],i=document.createTreeWalker(t.content,133,null,!1);let o=0,r=-1,a=0;const{strings:l,values:{length:c}}=e;for(;a<c;){const e=i.nextNode();if(null!==e){if(r++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:n}=t;let s=0;for(let e=0;e<n;e++)F(t[e].name,U)&&s++;for(;s-- >0;){const t=l[a],n=K.exec(t)[2],s=n.toLowerCase()+U,i=e.getAttribute(s);e.removeAttribute(s);const o=i.split(D);this.parts.push({type:"attribute",index:r,name:n,strings:o}),a+=o.length-1}}"TEMPLATE"===e.tagName&&(s.push(e),i.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(I)>=0){const s=e.parentNode,i=t.split(D),o=i.length-1;for(let t=0;t<o;t++){let n,o=i[t];if(""===o)n=J();else{const e=K.exec(o);null!==e&&F(e[2],U)&&(o=o.slice(0,e.index)+e[1]+e[2].slice(0,-U.length)+e[3]),n=document.createTextNode(o)}s.insertBefore(n,e),this.parts.push({type:"node",index:++r})}""===i[o]?(s.insertBefore(J(),e),n.push(e)):e.data=i[o],a+=o}}else if(8===e.nodeType)if(e.data===I){const t=e.parentNode;null!==e.previousSibling&&r!==o||(r++,t.insertBefore(J(),e)),o=r,this.parts.push({type:"node",index:r}),null===e.nextSibling?e.data="":(n.push(e),r--),a++}else{let t=-1;for(;-1!==(t=e.data.indexOf(I,t+1));)this.parts.push({type:"node",index:-1}),a++}}else i.currentNode=s.pop()}for(const e of n)e.parentNode.removeChild(e)}}const F=(e,t)=>{const n=e.length-t.length;return n>=0&&e.slice(n)===t},z=e=>-1!==e.index,J=()=>document.createComment(""),K=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const fe=(e,t)=>{const n=e.startNode.parentNode,s=void 0===t?e.endNode:t.startNode,i=n.insertBefore(J(),s);n.insertBefore(J(),s);const o=new se(e.options);return o.insertAfterNode(i),o},ge=(e,t)=>(e.setValue(t),e.commit(),e),me=(e,t,n)=>{const s=e.startNode.parentNode,i=n?n.startNode:e.endNode,o=t.endNode.nextSibling;o!==i&&V(s,t.startNode,o,i)},ve=e=>{M(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},be=(e,t,n)=>{const s=new Map;for(let i=t;i<=n;i++)s.set(e[i],i);return s},ye=new WeakMap,_e=new WeakMap,we=H((e,t,n)=>{let s;return void 0===n?n=t:void 0!==t&&(s=t),t=>{if(!(t instanceof se))throw new Error("repeat can only be used in text bindings");const i=ye.get(t)||[],o=_e.get(t)||[],r=[],a=[],l=[];let c,u,h=0;for(const t of e)l[h]=s?s(t,h):h,a[h]=n(t,h),h++;let d=0,p=i.length-1,f=0,g=a.length-1;for(;d<=p&&f<=g;)if(null===i[d])d++;else if(null===i[p])p--;else if(o[d]===l[f])r[f]=ge(i[d],a[f]),d++,f++;else if(o[p]===l[g])r[g]=ge(i[p],a[g]),p--,g--;else if(o[d]===l[g])r[g]=ge(i[d],a[g]),me(t,i[d],r[g+1]),d++,g--;else if(o[p]===l[f])r[f]=ge(i[p],a[f]),me(t,i[p],i[d]),p--,f++;else if(void 0===c&&(c=be(l,f,g),u=be(o,d,p)),c.has(o[d]))if(c.has(o[p])){const e=u.get(l[f]),n=void 0!==e?i[e]:null;if(null===n){const e=fe(t,i[d]);ge(e,a[f]),r[f]=e}else r[f]=ge(n,a[f]),me(t,n,i[d]),i[e]=null;f++}else ve(i[p]),p--;else ve(i[d]),d++;for(;f<=g;){const e=fe(t,r[g+1]);ge(e,a[f]),r[f++]=e}for(;d<=p;){const e=i[d++];null!==e&&ve(e)}ye.set(t,r),_e.set(t,l)}}),xe=new WeakMap,ke=H((e,t)=>n=>{const s=xe.get(n);if(Array.isArray(e)){if(Array.isArray(s)&&s.length===e.length&&e.every((e,t)=>e===s[t]))return}else if(s===e&&(void 0!==e||xe.has(n)))return;n.setValue(t()),xe.set(n,Array.isArray(e)?Array.from(e):e)}),Ee=H(e=>t=>{if(void 0===e&&t instanceof ne){if(e!==t.value){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else t.setValue(e)});let Pe={html:(e,...t)=>new Q(e,t,"html",ue),svg:(e,...t)=>new X(e,t,"svg",ue),render:(e,t,n)=>{let s=pe.get(t);void 0===s&&(M(t,t.firstChild),pe.set(t,s=new se(Object.assign({templateFactory:he},n))),s.appendInto(t)),s.setValue(e),s.commit()},directive:H,repeat:we,guard:ke,ifDefined:Ee};window.__litHtml?Pe=window.__litHtml:window.__litHtml=Pe;const{html:je,svg:Oe,render:Ce,directive:Ne,repeat:Se,guard:$e,ifDefined:Ae}=Pe;class He extends HTMLElement{constructor(e=!0){super(),this.setState=this.setState.bind(this),this.willMount=this.willMount.bind(this),this.render=this.render.bind(this),this.mounted=this.mounted.bind(this),this.shouldUpdate=this.shouldUpdate.bind(this),this.__update=this.__update.bind(this),this.updated=this.updated.bind(this),this.attributeChanged=this.attributeChanged.bind(this),this.propertyChanged=this.propertyChanged.bind(this),this.unmounted=this.unmounted.bind(this),this.__renderRoot=e?this.attachShadow({mode:"open"}):this;const{observedAttributes:t,observedPropertys:n,defineEvents:s,observedStores:i,adoptedStyleSheets:o}=new.target;t&&t.forEach(e=>{const t=function(e){return e.replace(/-(.)/g,(e,t)=>t.toUpperCase())}(e);if("function"==typeof this[t])throw"Don't use attribute with the same name as native methods";void 0===this[t]&&Object.defineProperty(this,t,{configurable:!0,get(){return this.getAttribute(e)||""},set(t){null===t?this.removeAttribute(e):this.setAttribute(e,t)}})}),n&&n.forEach(e=>{this.__connectProperty(e,!1)}),s&&s.forEach(e=>{this.__connectProperty(e,!0),this[e]=d}),i&&i.forEach(e=>{if(!e[p])throw new Error("`observedStores` only support store module");!function(e,t){e[p].add(t)}(e,this.__update)}),o&&(this.shadowRoot?this.shadowRoot.adoptedStyleSheets=o:document.adoptedStyleSheets=document.adoptedStyleSheets.concat(o))}get internals(){return this.__internals||(this.__internals=this.attachInternals()),this.__internals}__connectProperty(e,t=!1){if(e in this)return;let n=this[e];Object.defineProperty(this,e,{configurable:!0,get:()=>n,set(s){if(s!==n){if(t){if(s.isEventHandle)throw"Don't assign a wrapped event handler";n=t=>{const n=new CustomEvent(e.toLowerCase(),{detail:t});this.dispatchEvent(n),s(n)},n.isEventHandle=!0}else n=s;this.__isMounted&&(this.propertyChanged(e,n,s),i(this.__update))}}})}setState(e){if(!this.state)throw new Error("`state` not initialized");Object.assign(this.state,e),i(this.__update)}willMount(){}render(){return je`
    ...
    `}};h([i.b],d.prototype,"href",void 0),h([i.b],d.prototype,"path",void 0),h([i.b],d.prototype,"query",void 0),h([i.b],d.prototype,"hash",void 0),h([i.b],d.prototype,"docTitle",void 0),h([i.k],d.prototype,"route",void 0),h([i.k],d.prototype,"options",void 0),d=h([Object(i.g)("gem-link"),Object(i.d)(i.c)],d);let p=class extends d{render(){const{path:e,query:t,hash:n}=i.i.getParams(),s=this.pattern&&l(this.pattern,e),o=this.getHref();return this.active=!(!s&&e+t+n!==o),super.render(o)}};h([i.b],p.prototype,"pattern",void 0),h([i.l],p.prototype,"active",void 0),p=h([Object(i.g)("gem-active-link"),Object(i.d)(i.i.store)],p);var f=function(e,t,n,s){var i,o=arguments.length,r=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,n):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,n,s);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(r=(o<3?i(r):o>3?i(t,n,r):i(t,n))||r);return o>3&&r&&Object.defineProperty(t,n,r),r};let g=class extends i.a{constructor(e){super(),this.hidden=e}static setTitle(e){i.i.updateParams({title:e})}render(){const{title:e}=i.i.getParams(),t=e||this.textContent||"";return("safe"!==this.mode||t)&&(document.title=t),this.hidden?i.j``:document.title?i.j`
      ${document.title}
    `:i.j`
        <slot></slot>
      `}};f([i.b],g.prototype,"mode",void 0),g=f([Object(i.d)(i.i.store),Object(i.g)("gem-title")],g),document.head&&!document.head.querySelector("gem-title")&&document.head.append(new g(!0));var m,v=n(1);customElements.define("app-page-b",((m=class extends i.a{render(){return i.j`
        <slot></slot> ${v.a.pageB.text}
      `}}).observedStores=[v.a.pageB],m)),setTimeout(()=>n.e(1).then(n.bind(null,3)));const b=[{title:"ccccccd",pattern:"/c/d",content:i.j`
      <div>C/D</div>
    ...
    `}];customElements.define("app-page-c",class extends i.a{render(){return i.j`
      ...
      `}});const y=[{pattern:"/",redirect:"/c/e"},{title:"Page A Title",pattern:"/a",get content(){return n.e(2).then(n.bind(null,4)),i.j`
    ...
    `},{pattern:"/",content:i.j`
      <div>hello</div>
    `}];class _ extends i.a{render(){return i.j`
      <style>
        :host {
          text-align: center;
        }
      ...
      <main>
        <gem-route .routes=${y}></gem-route>
      </main>
    `}}const w=document.createElement("style");w.innerHTML=i.f`
  body {
    font-size: xx-large;
  }
`,document.head.append(w),customElements.define("app-root",_),document.body.append(new _)}]);
//# sourceMappingURL=bundle.4a00d221816d653e1905.js.map