 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const W=` ${$} `;class B{constructor(t,e,s,n){this.strings=t,this.values=e,this.type=s,this.processor=n}getHTML(){const t=this.strings.length-1;let e="",s=!1;for(let n=0;n<t;n++){const t=this.strings[n],i=t.lastIndexOf("\x3c!--");s=(i>-1||s)&&-1===t.indexOf("--\x3e",i+1);const o=L.exec(t);e+=null===o?t+(s?W:M):t.substr(0,o.index)+o[1]+o[2]+V+o[3]+$}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class G extends B{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,s=e.firstChild;return e.removeChild(s),k(e,s.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const et=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new Q(t,e.slice(1),s).parts}return"@"===i?[new Z(t,e.slice(1),n.eventContext)]:"?"===i?[new K(t,e.slice(1),s)]:new z(t,e,s).parts}handleTextExpression(t){return new J(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const ot=(t,e)=>{const s=t.startNode.parentNode,n=void 0===e?t.endNode:e.startNode,i=s.insertBefore(I(),n);s.insertBefore(I(),n);const o=new J(t.options);return o.insertAfterNode(i),o},rt=(t,e)=>(t.setValue(e),t.commit(),t),at=(t,e,s)=>{const n=t.startNode.parentNode,i=s?s.startNode:t.endNode,o=e.endNode.nextSibling;o!==i&&k(n,e.startNode,o,i)},lt=t=>{A(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},ht=(t,e,s)=>{const n=new Map;for(let i=e;i<=s;i++)n.set(t[i],i);return n},ct=new WeakMap,dt=new WeakMap,ut=E((t,e,s)=>{let n;return void 0===s?s=e:void 0!==e&&(n=e),e=>{if(!(e instanceof J))throw new Error("repeat can only be used in text bindings");const i=ct.get(e)||[],o=dt.get(e)||[],r=[],a=[],l=[];let h,c,d=0;for(const e of t)l[d]=n?n(e,d):d,a[d]=s(e,d),d++;let u=0,p=i.length-1,f=0,g=a.length-1;for(;u<=p&&f<=g;)if(null===i[u])u++;else if(null===i[p])p--;else if(o[u]===l[f])r[f]=rt(i[u],a[f]),u++,f++;else if(o[p]===l[g])r[g]=rt(i[p],a[g]),p--,g--;else if(o[u]===l[g])r[g]=rt(i[u],a[g]),at(e,i[u],r[g+1]),u++,g--;else if(o[p]===l[f])r[f]=rt(i[p],a[f]),at(e,i[p],i[u]),p--,f++;else if(void 0===h&&(h=ht(l,f,g),c=ht(o,u,p)),h.has(o[u]))if(h.has(o[p])){const t=c.get(l[f]),s=void 0!==t?i[t]:null;if(null===s){const t=ot(e,i[u]);rt(t,a[f]),r[f]=t}else r[f]=rt(s,a[f]),at(e,s,i[u]),i[t]=null;f++}else lt(i[p]),p--;else lt(i[u]),u++;for(;f<=g;){const t=ot(e,r[g+1]);rt(t,a[f]),r[f++]=t}for(;u<=p;){const t=i[u++];null!==t&&lt(t)}ct.set(e,r),dt.set(e,l)}}),pt=new WeakMap,ft=E((t,e)=>s=>{const n=pt.get(s);if(Array.isArray(t)){if(Array.isArray(n)&&n.length===t.length&&t.every((t,e)=>t===n[e]))return}else if(n===t&&(void 0!==t||pt.has(s)))return;s.setValue(e()),pt.set(s,Array.isArray(t)?Array.from(t):t)}),gt=E(t=>e=>{if(void 0===t&&e instanceof D){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)});let mt={html:(t,...e)=>new B(t,e,"html",et),svg:(t,...e)=>new G(t,e,"svg",et),render:(t,e,s)=>{let n=it.get(e);void 0===n&&(A(e,e.firstChild),it.set(e,n=new J(Object.assign({templateFactory:st},s))),n.appendInto(e)),n.setValue(t),n.commit()},directive:E,repeat:ut,guard:ft,ifDefined:gt};window.__litHtml?mt=window.__litHtml:window.__litHtml=mt;const{html:_t,svg:vt,render:wt,directive:bt,repeat:yt,guard:xt,ifDefined:St}=mt;class Et extends HTMLElement{constructor(t=!0){super(),this.setState=this.setState.bind(this),this.willMount=this.willMount.bind(this),this.render=this.render.bind(this),this.mounted=this.mounted.bind(this),this.shouldUpdate=this.shouldUpdate.bind(this),this.__update=this.__update.bind(this),this.updated=this.updated.bind(this),this.attributeChanged=this.attributeChanged.bind(this),this.propertyChanged=this.propertyChanged.bind(this),this.unmounted=this.unmounted.bind(this),this.__renderRoot=t?this.attachShadow({mode:"open"}):this;const{observedAttributes:e,observedPropertys:s,defineEvents:n,observedStores:i,adoptedStyleSheets:o}=new.target;e&&e.forEach(t=>{const e=function(t){return t.replace(/-(.)/g,(t,e)=>e.toUpperCase())}(t);if("function"==typeof this[e])throw"Don't use attribute with the same name as native methods";void 0===this[e]&&Object.defineProperty(this,e,{configurable:!0,get(){return this.getAttribute(t)||""},set(e){null===e?this.removeAttribute(t):this.setAttribute(t,e)}})}),s&&s.forEach(t=>{this.__connectProperty(t,!1)}),n&&n.forEach(t=>{this.__connectProperty(t,!0),this[t]=u}),i&&i.forEach(t=>{if(!t[p])throw new Error("`observedStores` only support store module");!function(t,e){t[p].add(e)}(t,this.__update)}),o&&(this.shadowRoot?this.shadowRoot.adoptedStyleSheets=o:document.adoptedStyleSheets=document.adoptedStyleSheets.concat(o))}__connectProperty(t,e=!1){if(t in this)return;let s=this[t];Object.defineProperty(this,t,{configurable:!0,get:()=>s,set(n){if(n!==s){if(e){if(n.isEventHandle)throw"Don't assign a wrapped event handler";s=e=>{const s=new CustomEvent(t.toLowerCase(),{detail:e});this.dispatchEvent(s),n(s)},s.isEventHandle=!0}else s=n;this.__isMounted&&(this.propertyChanged(t,s,n),r(this.__update))}}})}setState(t){if(!this.state)throw new Error("`state` not initialized");Object.assign(this.state,t),r(this.__update)}willMount(){}render(){return _t`
      <slot></slot>
    `}mounted(){}shouldUpdate(){return!0}__update(){this.__isMounted&&this.shouldUpdate()&&(wt(this.render(),this.__renderRoot),this.updated())}update(){this.__update()}updated(){}propertyChanged(t,e,s){}attributeChanged(t,e,s){}unmounted(){}attributeChangedCallback(t,e,s){this.__isMounted&&(this.attributeChanged(t,e,s),r(this.__update))}disconnectedCallback(){const t=this.constructor;t.observedStores&&t.observedStores.forEach(t=>{!function(t,e){t[p].delete(e)}(t,this.__update)}),this.unmounted(),this.__isMounted=!1}}class Nt extends Et{connectedCallback(){this.willMount(),wt(this.render(),this.__renderRoot),this.mounted(),this.__isMounted=!0}}const Ot=new a;let kt=!1;const At=()=>{window.requestAnimationFrame((function t(e){const s=Ot.get();s&&(s(),performance.now()-e<16)?t(e):kt&&At()}))};Ot.addEventListener("start",()=>{kt=!0,At()}),Ot.addEventListener("end",()=>kt=!1);const Ct=customElements.define.bind(customElements);customElements.define=function(t,e,s){customElements.get(t)||Ct(t,e,s)};const Pt=Symbol("open mark");function $t(t){var e;return(e=class extends Nt{constructor(){super(),this.closeHandle=this.closeHandle.bind(this)}static get isOpen(){return this.store[Pt]}static get observedStores(){return[x.historyState,this.store]}static open(t){const e=()=>g(this.store,Object.assign({[Pt]:!0},t));e(),x.pushState({open:e,close:this.close.bind(this),shouldClose:this.shouldClose.bind(this)})}static close(){g(this.store,Object.assign({[Pt]:!1},t))}static shouldClose(){return!0}closeHandle(){x.back()}render(){return _t``}}).store=f(Object.assign({[Pt]:!1},t)),e}class Mt extends RegExp{constructor(t){const e={};let s=0;super(`^${t.replace(/:([^/$]+)/g,(t,n)=>(e[n]=s++,"([^/]+)")).replace("*",".*")}$`),this.namePosition=e}}function Tt(t){return new Mt(t)}function Vt(t,e){return!!e.match(Tt(t))}function Rt(t,e){let s=t.pattern;return e&&e.params&&Object.keys(e.params).forEach(t=>{s=s.replace(new RegExp(`:${t}`,"g"),e.params[t])}),s}class Ht extends Nt{constructor(){super();const{path:t,query:e}=x.location,s=t+e;this.href=s}static getParams(){if(Ht.currentRoute)return function(t,e){const s=Tt(t),n=e.match(s);if(n){const t={};return Object.keys(s.namePosition).forEach(e=>{t[e]=n[s.namePosition[e]+1]}),t}}(Ht.currentRoute.pattern,x.location.path)}initPage(){const{list:t,currentIndex:e}=x.historyState;Ht.currentRoute&&Ht.currentRoute.title&&Ht.currentRoute.title!==t[e].title&&(t.splice(e,1,Object.assign(Object.assign({},t[e]),{title:Ht.currentRoute.title})),g(x.historyState,{list:t}))}shouldUpdate(){const{path:t,query:e}=x.location,s=t+e;return t+e!==this.href&&(this.href=s,!0)}mounted(){this.initPage()}updated(){this.initPage(),this.dispatchEvent(new CustomEvent("change"))}render(){if(!this.routes)return this.callback();Ht.currentRoute=null;let t,e=null;t=this.routes instanceof Array?this.routes:Object.values(this.routes);for(const s of t){const{pattern:t}=s;if("*"===t)e=s;else if(Vt(t,x.location.path)){Ht.currentRoute=s;break}}return Ht.currentRoute||(Ht.currentRoute=e),Ht.currentRoute?Ht.currentRoute.redirect?(x.replace({path:Ht.currentRoute.redirect}),this.callback()):_t`
      <style>
        :host {
          display: contents;
        }
      </style>
      ${Ht.currentRoute.content}
    `:this.callback()}callback(){return Ht.currentRoute=null,_t``}}Ht.observedPropertys=["routes"],Ht.observedStores=[x.historyState],customElements.define("gem-route",Ht);class jt extends Nt{constructor(){super(),this.clickHandle=t=>{const e=this.getHref();if(!e.startsWith("/"))return void window.open(e);const{path:s,query:n,hash:i}=x.location;s+n+i!==e&&(t.stopPropagation(),this.route?x.pushWithoutCloseHandle(function(t,e){const s=Rt(t,e);return Object.assign({path:s},e)}(this.route,this.options)):x.pushWithoutCloseHandle({path:this.path,query:this.query,hash:this.hash}))},this.onclick=this.clickHandle}getHref(){if(this.route){const t=this.options?this.options.query:"",e=this.options?this.options.hash:"";return Rt(this.route,this.options)+t+e}return this.href||this.path+this.query+this.hash}render(){const{path:t,query:e,hash:s}=x.location;return this.pattern&&Vt(this.pattern,t)||t+e+s===this.getHref()?this.setAttribute("active",""):this.removeAttribute("active"),_t`
      <slot></slot>
    `}}jt.observedAttributes=["href","path","query","hash","pattern"],jt.observedStores=[x.historyState],jt.observedPropertys=["route","options"],customElements.define("gem-link",jt);class It extends($t({content:_t``})){render(){return _t`
      <style>
        .root {
          position: fixed;
          top: 0;
...
//# sourceMappingURL=bundle.afc9da59928a845a6155.js.map